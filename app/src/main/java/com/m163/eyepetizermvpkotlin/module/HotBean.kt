...
data class HotBean(var count: Int, var total: Int, var nextPageUrl: Any?, var itemList: MutableList<ItemListBean>?) {
    ...
    data class ItemListBean(var type: String?, var data: DataBean?, var tag: Any?) {
        ...
        data class DataBean(var dataType: String?, var id: Int, var title: String?,
                            ...
                            var lastViewTime: Any?, var playInfo: MutableList<PlayInfoBean>?, var tags: MutableList<TagsBean>?,
                            var labelList: MutableList<*>?, var subtitles: MutableList<*>?) {
